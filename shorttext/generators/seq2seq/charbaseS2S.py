...
class CharBasedSeq2SeqGenerator:
    def __init__(self, dictionary, latent_dim, maxlen):
    ...
    def train(self, txtseq, batch_size=64, epochs=100):
    ...
    def decode(self, txtseq):
        ...
        inputvec = np.array([self.sent2charvec_encoder.encode_sentence(txtseq, endsig=True).toarray()])
    ...
    def savemodel(self, prefix, final=False):
        ...
        json.dump(open(prefix+'_charbases2s.json', 'wb'), {'maxlen': self.maxlen, 'latent_dim': self.latent_dim})
