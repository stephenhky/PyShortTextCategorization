...
class CharSeq2SeqWithKeras:
    def __init__(self, nbchars, vecsize, latent_dim):
    ...
    def prepare_model(self):
        ...
        encoder_inputs = Input(shape=(None, self.nbchars))
        ...
        decoder_inputs = Input(shape=(None, self.nbchars))
        ...
        decoder_dense = Dense(self.nbchars, activation='softmax')
