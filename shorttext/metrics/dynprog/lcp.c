...
static PyMethodDef __pyx_mdef_9shorttext_7metrics_7dynprog_3lcp_1longest_common_prefix = {"longest_common_prefix", (PyCFunction)__pyx_pw_9shorttext_7metrics_7dynprog_3lcp_1longest_common_prefix, METH_VARARGS|METH_KEYWORDS, 0};
 ...
 *     cdef int len2 = len(word2)
 */
  __pyx_tuple__10 = PyTuple_Pack(6, __pyx_n_s_word1, __pyx_n_s_word2, __pyx_n_s_len1, __pyx_n_s_len2, __pyx_n_s_lcp, __pyx_n_s_i); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(2, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_shorttext_metrics_dynprog_lcp_py, __pyx_n_s_longest_common_prefix, 5, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init shorttext.metrics.dynprog.lcp", 0, __pyx_lineno, __pyx_filename);
    }
